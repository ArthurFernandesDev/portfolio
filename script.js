...
function openVideoModal() {
  ...
  // youtube-nocookie.com: mais permissivo que youtube.com em GitHub Pages
  // autoplay=1 funciona somente com interação direta do usuário (clique no botão)
  iframe.src = 'https://www.youtube-nocookie.com/embed/geOoP1lVYII?autoplay=1&rel=0&modestbranding=1&playsinline=1';
...
function closeVideoModal() {
  ...
  // Para o vídeo imediatamente ao fechar (limpa o src)
